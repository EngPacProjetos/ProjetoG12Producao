function servicetask200(attempt, message) {
    ...
    try {
        ...
        if (dataset == null || dataset.rowsCount == 0) {
            throw ("[G12] Nenhuma informacao de autorização da nota fiscal retornada após " + MAX_TENTATIVAS + " tentativas. IdMov=" + idMov + " CodColigada=" + codColigada);
        }
